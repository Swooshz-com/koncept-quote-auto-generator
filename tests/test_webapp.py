...
"""
    ...
    def test_static_webapp_shows_generated_downloads_inside_assistant_page(self):
        ...
        self.assertIn("openPendingPdfWindow", js)
        self.assertIn("navigatePendingPdfWindow", js)
        self.assertIn("closePendingPdfWindow", js)
        ...
        self.assertIn("const pendingPdfWindow = openPendingPdfWindow();", pdf_handler)
        self.assertLess(pdf_handler.index("const pendingPdfWindow = openPendingPdfWindow();"), pdf_handler.index("await waitForUiPaint();"))
        self.assertIn("await handleGenerate({ viewPdf: true });", pdf_handler)
        self.assertIn("navigatePendingPdfWindow(pendingPdfWindow)", pdf_handler)
        self.assertIn("closePendingPdfWindow(pendingPdfWindow)", pdf_handler)

...
"""
    ...
    def test_static_webapp_exposes_dynamic_quote_fields_and_analysis_controls(self):
        ...
        self.assertIn("<h4>Select Profile</h4>", html)
        self.assertIn("Save &amp; Manage Data", html)
        self.assertIn("More Actions", html)
        self.assertIn("Import Profile", html)
        ...
        self.assertIn(".company-preset-select-card", css)
        self.assertIn(".company-preset-save-row", css)
        self.assertIn(".company-preset-more-actions", css)
